        ...
        <div className="max-w-3xl mx-auto text-slate-900 mt-1 sticky">
          <header className="p-6 border-b flex items-center justify-between bg-blue-500 rounded-lg rounded-br-lg">
            <div>
              ...
              <p className="text-white text-xs px-1 py-1">Developed by <strong  className="hover:text-black"><Link href={"https://www.linkedin.com/in/khan1203"}>Khan Muhammad Rifat</Link></strong></p>
            </div>
            <Link
